...
struct DRS_CV
{
  ...
  void   checkFilenameEncoding(std::string&, struct DRS_CV_Table&, int );
 ...
 void    findFN_faults(Split&, Split&,
  ...
  std::vector<std::string> modelDSetRef;
  std::vector<std::string> generalDSetRef;
  std::vector<std::string> modelFNameRef;
  std::vector<std::string> generalFNameRef;

  // index 0: model, 1: general
  std::vector<std::vector<bool> > isDSetReq;
  std::vector<std::vector<bool> > isFNameReq;
